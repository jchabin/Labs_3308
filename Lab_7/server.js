//  I was unable to get Docker to run, and so I couldn't use any db functions.
//  (NodeJS still works)
//  I did what I could without knowing whether the db would work or not, and got stuck
//  partway through, partial credit is still better than no credit though.
...
app.get('/team_stats', function(req, res) {
	var game_sql = "select * from football_games;"; // Write a SQL query to retrieve the color message for the selected color
	db.task('get-everything', task => {
        return task.batch([
            task.any(game_sql)
        ]);
